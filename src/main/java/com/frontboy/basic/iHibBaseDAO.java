...
public interface iHibBaseDAO {
	 ...
	 * @return int  >0  返回的是主键 ，    ==0  失败， ==Integer.MAX_VALUE,也代表成功
	 */
	 ...
	 * @param String sql 无参数的select的sql语句
	 * @return List 查询返回记录队列
	 */
	public List selectBysql(String sql) throws SQLException;
